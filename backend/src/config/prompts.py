...
- Create a SEPARATE section for EVERY major topic in the materials. Do not merge distinct topics together. Prefer MORE sections (aim for 8-15 sections when the material supports it) over a few broad ones.
...
- COVER THE PAST EXAMS HEAVILY: every topic, concept, and question type that appears in the historical exams MUST get its own section or detailed treatment. These are the highest-priority topics — go deep on them.
